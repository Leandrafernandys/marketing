...
//   preenche a lista dos estados com a API do IBGE quando a página e carregada
$.ajax({
    url: 'https://servicodados.ibge.gov.br/api/v1/localidades/estados?orderBy=nome',
    success: function(dados){
        //console.log('<option>' + dados[15].nome + '</option');
        var tag = '';
...
//atualiza cidade quando um Estado é selecionado
